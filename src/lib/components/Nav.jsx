...
export default function Nav() {
  ...
  const pages = [
    ...
    { name: 'ABOUT', href: '#welcome', isRoute: false },
    ...
    >
      ...
      <div className="flex items-center">
        <div className="hidden items-center gap-4 lg:flex">
          ...
          <div className="group relative">
            <button
              className={classNames(
                'rounded-md px-3 py-2 text-left font-exo transition-all',
                shadow
            ...
            <div
              className="invisible absolute right-0 mt-2 w-40 transform rounded-md bg-white py-1 opacity-0 shadow-lg transition-all group-hover:visible group-hover:opacity-100 dark:bg-gray-800"
              role="menu"
              aria-label="International"
            >
              <Link
                to="/china"
                className="block px-4 py-2 font-exo text-gray-800 hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700"
              >
                CHINA
              </Link>
              <Link
          ...
          <a
            ...
            className="ml-2 rounded-md bg-red-600 p-2 px-5 font-exo text-white hover:bg-red-400 dark:bg-red-600 dark:hover:bg-red-400"
          >
            APPLY
          </a>
      ...
      {open && (
        <div className="p-dynamic fixed left-0 top-20 z-50 flex h-[calc(100vh-5rem)] w-screen flex-col gap-4 bg-white dark:bg-gray-900 lg:hidden">
          ...
          <div className="px-4">
            <div className="mb-1 font-exo text-sm font-medium text-red-600 dark:text-red-400">
              INTERNATIONAL
            </div>
            <Link
              to="/china"
              className="block rounded-md px-4 py-3 font-exo text-gray-800 transition-all hover:bg-gray-100 dark:text-white dark:hover:bg-gray-800"
              onClick={() => setOpen(false)}
            >
              CHINA
            </Link>
            <Link
              to="/india"
              className="mt-1 block rounded-md px-4 py-3 font-exo text-gray-800 transition-all hover:bg-gray-100 dark:text-white dark:hover:bg-gray-800"
              onClick={() => setOpen(false)}
            >
              INDIA
            </Link>
