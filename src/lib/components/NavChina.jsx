...
export default function NavChina() {
  ...
  const pages = [
    ...
    { name: 'TRACKS', href: '#tracks', isExternal: false },
    { name: 'SCHEDULE', href: '#schedule', isExternal: false },
  ...
  function scrollToSection(event, href, isExternal) {
      ...
      <div>
        <div className="inline-flex items-center gap-2 rounded-md border border-gray-200 p-2 dark:border-secondary">
          <a className="shrink-0" href="/">
            <img className="h-10" src="/logo.svg" alt="HackHarvard" />
          </a>
        </div>
      </div>
        ...
        <div className="hidden items-center gap-4 lg:flex">
          {pages.map(page => (
            <a
              key={page.href}
              href={page.href}
              onClick={e => scrollToSection(e, page.href, page.isExternal)}
              className={classNames(
          ...
          <a
            ...
            className="ml-2 rounded-md bg-red-600 p-2 px-5 font-exo text-white transition-all hover:bg-red-700 dark:bg-red-700 dark:hover:bg-red-800"
          >
            APPLY
          </a>
          <button
        ...
        <div className="p-dynamic fixed left-0 top-20 z-50 flex h-[calc(100vh-5rem)] w-screen flex-col gap-4 bg-white dark:bg-gray-900 lg:hidden">
          {pages.map(page => (
            <a
              ...
              href={page.href}
              onClick={e => {
                scrollToSection(e, page.href, page.isExternal)
                setOpen(false)
              }}
              className={classNames(
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="rounded-md bg-red-600 p-3 px-4 font-exo text-white transition-all hover:bg-red-700 dark:bg-red-700 dark:hover:bg-red-800"
          >
            APPLY
          </a>
          <button
