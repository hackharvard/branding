...
export default function FaqChina() {
  return (
    <div className="bg-white dark:bg-gray-900">
      <div className="p-dynamic flex justify-center" id="faq">
        <div className="w-full max-w-3xl rounded-lg bg-white p-8 shadow-lg dark:bg-black">
          <div>
            <h1 className="font-exo text-4xl uppercase text-red-700 dark:text-red-500 sm:text-5xl">
              FAQ
            </h1>
            ...
            <p className="text-sm text-gray-700 dark:text-gray-300">
              Please email us at{' '}
              <a
                className="text-blue-900 hover:underline dark:text-blue-200"
                href="mailto:china@hackharvard.io"
              >
